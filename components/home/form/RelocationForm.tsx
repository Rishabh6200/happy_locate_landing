            ...
            <Box className="flex flex-col lg:flex-row items-end gap-4 p-3 px-2 pl-5 pb-5 bg-white shadow-sm rounded-lg overflow-x-auto whitespace-nowrap">
               ...
               <div className="flex flex-col justify-end max-lg:w-full">
                  ...
                  <RadioGroup
                     ...
                     className="flex"
                  >
                     <FormControlLabel value="domestic" control={<Radio />} label={<span className='lg:text-[11px]'>Domestic</span>} />
                     <FormControlLabel value="international" control={<Radio />} label={<span className='lg:text-[11px]'>International</span>} />
                  </RadioGroup>
               </div>
